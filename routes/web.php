...
Route::get('tarefa/exportacar', [App\Http\Controllers\TarefaController::class, 'exportar'])->name('tarefa.exportar');
...
Route::get('/mensagem-teste', function(){
  ...
  // Mail::to('anderson@viafast.com.br')->send(new MensagemTesteMail());
